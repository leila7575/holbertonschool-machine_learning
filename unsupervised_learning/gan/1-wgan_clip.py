#!/usr/bin/env python3
"""contains simple Wasserstein GAN model class"""
...
class WGAN_clip(keras.Model) :
    ...
    def get_fake_sample(self, size=None, training=False):
        """Generates a fake sample by applying the image of generator to latent sample"""
        if not size :
    ...
    def train_step(self,useless_argument):
        ...
        for _ in range(self.disc_iter) :
            ...
            gradients_discriminator = g_discr.gradient(discr_loss,self.discriminator.trainable_variables)
