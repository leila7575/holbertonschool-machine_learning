...
def resnet50():
    ...
    re_lu1 = K.layers.ReLU(name="re_lu")(batch_norm1)  # Ajout du nom attendu
    ...
    conv3_1 = projection_block(conv2_3, filters=(128, 128, 512), s=2)
    ...
    conv4_1 = projection_block(conv3_4, filters=(256, 256, 1024), s=2)
    ...
    conv5_1 = projection_block(conv4_6, filters=(512, 512, 2048), s=2)
    ...
    flatten = K.layers.Flatten()(avg_pool)  # Ajout d'un Flatten pour éviter erreurs de dimension
